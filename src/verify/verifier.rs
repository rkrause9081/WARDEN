...
//!
//! Later extension:
//! - Query WardenEvidence.sol and confirm the hash exists on-chain.
...
use crate::verify::hash::{compute_canonical_alert_hash, hash_to_hex, normalize_hex};
...
pub fn verify_alert_log_line(line_number: usize, line: &str) -> VerificationResult {
    ...
    let recomputed_hash = hash_to_hex(compute_canonical_alert_hash(
        &record.src_ip,
        &record.protocol,
        &record.msg_type,
        record.pps,
...
mod tests {
    ...
    fn detects_tampered_line() {
        let line = r#"{"logged_at":"2026-05-26T03:29:36Z","src_ip":"127.0.0.1","protocol":"MQTT","msg_type":"PUBLISH","pps":999.0,"evidence_hash_hex":"0x96e0502eed7fad79c07f7620c13c026468418898f71af1b2fbd5c9c770a213ab","action":"ALERT"}"#;
    ...
    fn detects_missing_hash() {
        let line = r#"{"logged_at":"2026-05-26T03:29:36Z","src_ip":"127.0.0.1","protocol":"MQTT","msg_type":"CONNECT","pps":1.0,"evidence_hash_hex":null,"action":"ALERT"}"#;
